...
//						System.out.println(( 1000000000d/(timeNow - timeStartNanos)) + ", " + timeNow + "/t" + timeStartNanos);
	...
	private static void startMultithreading(int trianglesAmount, int threadsAmount) {
	...
	public static class ThreadProcessor extends Thread {
...
//		}
		...
		private static ThreadProcessor[] threadRegister;
